...
<head>
    ...
    function paging_pblist() {
        window.location = "pblist.php?pg=" + document.getElementById("page").value + "&tr=" + document.getElementById(
...
<body>
    ...
    <form name="pblist" id="pblist" method="post" action="pblist.php" onsubmit="return validate_dateselection()">
        <table align="center" border="0" cellpadding="2" cellspacing="1" width="875">
            <tbody>
                <tr align="center"
                    style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size: xx-large; font-weight: normal ; color: #CC9933">
                    <td>Purchase Bill List</td>
                </tr>
                <tr align="center"
		...
		while($row_item=mysql_fetch_array($sql_item)){
			...
			echo '</tr>';
                ...
                <tr>
                    <td align="center">
                        <?php 
	$sql_total = mysql_query("SELECT * FROM tblbill WHERE bill_return=0 AND (bill_date BETWEEN '".date("Y-m-d",$sm)."' AND '".date("Y-m-d",$em)."')") or die(mysql_error());
