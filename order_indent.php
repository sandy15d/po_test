...
<body>
    <section class="main-section">
        <div class="container-fluid">
            ...
            <div class="col-md-12" id="form1">
                <div class="left-box">
                    ...
                    <form id="add_order_form" action="javascript:void(0);">
                        ...
                        <input type="hidden" name="maxDate" id="maxDate" value="<?php echo date("Y-m-d", strtotime($_SESSION["stores_syr"])); ?>" />
                        <div class="shadow p-3 mb-5 bg-white rounded">
                            <div class="row">
                                ...
                                <div class="col-md-2 mb-3">
                                    <label for="location">Indent From: <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-2 mb-3">
                                    <label for="indent_date">Indent Date : <span class="text-danger">*</span></label>
                                    <input type="date" name="indent_date" id="indent_date" class="form-control" value="<?php echo date('Y-m-d'); ?>" />
                                    <div id="indent_date_err" style="color:red; display:none;"></div>
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="supply_date">Estimated Supply Date: <span class="text-danger">*</span></label>
                                    <input type="date" name="supply_date" id="supply_date" class="form-control" value="<?php echo date('Y-m-d'); ?>" />
                                </div>
                                <div class="col-md-2 mb-3">
                                ...
                                <div class="col-md-2 mb-3">
                                    <label for="quotation_attachment">Quotation File</label>
                                    <input type="file" name="quotation_attachment" id="quotation_attachment" class="form-control" accept="application/*">
                                </div>
                                ...
                                <div class="col-md-12 mb-12" id="insert" name="insert">
                                    ...
                                    <?php if ($row_user['oi1'] == 1) { ?>
                                        <button class="btn btn-md btn-primary pull pull-right" id="create_indent" name="create_indent">Create
                                            Indent</button>
                                    <?php } ?>
                                    <button type="reset" class="btn btn-md btn-danger pull pull-right" style="margin-right:2px;">Reset</button>
            ...
            <div class="row" id="item-insert" style="display: none;">
                <div class="col-md-4">
                    <div>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <form id="add_new_item" action="javascript:void(0);">
                                ...
                                <input type="hidden" id="indent_order_id" name="indent_order_id">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="err" id="unit_err" style="display:none"></div>
                                </div>
                                <div class="col-md-12">
                                    <label for="desc">Description:</label>
                                    <textarea rows="2" cols="57" name="desc" id="desc" class="form-control" spellcheck="false"> </textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button class="btn btn-md btn-primary pull pull-right" id="add_item" name="add_item">Save Changes</button>
                ...
                <div class="col-md-8" id="table1">
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-lg pull pull-right btn-success" id="order_now" name="order_now" style="display:none">Order
                            Now</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).on('click', '#create_indent', function() {
            ...
            var quotation_attachment = $("#quotation_attachment")[0].files;
            ...
            if (order_by == "") {
                ...
                $('#order_by_err').css('display', 'none');
            }
            if (formValid) {
                var formData = new FormData();
                formData.append('action', 'add_order_indent');
                formData.append('indent_date', indent_date);
                formData.append('supply_date', supply_date);
                formData.append('location', location);
                formData.append('order_by', order_by);
                formData.append('quotation_attachment', quotation_attachment[0]);
