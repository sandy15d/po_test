	...
	if($_POST['submit']=="update"){
		if($count>0){
			...
			elseif($row_party['party_id']==$pid){
				$res = mysql_query("UPDATE party SET party_name='".$_POST['partyName']."',address1='".$_POST['address1']."',address2='".$_POST['address2']."',address3='".$_POST['address3']."',city_id=".$_POST['city'].",contact_person='".$_POST['contactPerson']."',email_id='".$_POST['emailID']."',mobile_no='".$_POST['mobileNo']."',pan='".$_POST['pan']."',tin='".$_POST['tin']."',gstno='".$_POST['gst']."',op_balance=".$opBal.",credit_days=".$crDays.",category=".$_POST['category']." WHERE party_id=".$pid) ;
				echo '<script language="javascript">window.location="party.php?action=new";</script>';
			}
		} elseif($count==0){
			$res = mysql_query("UPDATE party SET party_name='".$_POST['partyName']."',address1='".$_POST['address1']."',address2='".$_POST['address2']."',address3='".$_POST['address3']."',city_id=".$_POST['city'].",contact_person='".$_POST['contactPerson']."',email_id='".$_POST['emailID']."',mobile_no='".$_POST['mobileNo']."',pan='".$_POST['pan']."',tin='".$_POST['tin']."',gstno='".$_POST['gst']."',op_balance=".$opBal.",credit_days=".$crDays.",category=".$_POST['category']." WHERE party_id=".$pid) ;
			echo '<script language="javascript">window.location="party.php?action=new";</script>';
		...
		if($count>0)
			...
			$row = mysql_fetch_assoc($sql);
			$pid = $row["maxid"] + 1;
			$sql = "INSERT INTO party VALUES(".$pid.",'".$_POST['partyName']."','".$_POST['address1']."','".$_POST['address2']."','".$_POST['address3']."',".$_POST['city'].",'".$_POST['contactPerson']."','".$_POST['emailID']."','".$_POST['mobileNo']."','".$_POST['pan']."','".$_POST['tin']."','".$_POST['gst']."',".$opBal.",".$crDays.",".$_POST['category'].")";
			$res = mysql_query($sql) ;
			echo '<script language="javascript">window.location="party.php?action=new";</script>';
		}
	}
...
function paging_party()
{
	if(document.getElementById("xson").value=="new")
		window.location="party.php?action="+document.getElementById("xson").value+"&pg="+document.getElementById("page").value+"&tr="+document.getElementById("displayTotalRows").value;
	else
		window.location="party.php?action="+document.getElementById("xson").value+"&pid="+document.getElementById("ptyid").value+"&pg="+document.getElementById("page").value+"&tr="+document.getElementById("displayTotalRows").value;
}
...
<tr>
	...
	<tr>
		...
		<tr class="Controls">
			...
			<td><input name="gst" id="gst" maxlength="15" size="20" value="<?php echo $gst;?>"></td>
		</tr>
		...
		<?php }?>
&nbsp;&nbsp;<a href="javascript:window.location='party.php?action=new'"><img src="images/reset.gif" width="72" height="22" style="display:inline; cursor:hand;" border="0" /></a>
...
<tr>
	...
	<tr>
		...
		while($row_party=mysql_fetch_array($sql_party))
		{
			$i++;
			echo '<tr class="Row">';
			$delete_ref = "party.php?action=delete&pid=".$row_party['party_id'];
			$edit_ref = "party.php?action=edit&pid=".$row_party['party_id'];
